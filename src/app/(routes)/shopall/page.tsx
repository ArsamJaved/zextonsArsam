...
export default function ShopAll() {
  ...
  useEffect(() => {
    if (products.length === 0) {
      dispatch(fetchProducts()); // You might need to define the fetchProducts action type
    } else {
      setFilteredProducts(products); // Initialize filtered products when products are fetched
    }
  }, [dispatch, products]);
